...
| <a name="input_policy_assignments"></a> [policy\_assignments](#input\_policy\_assignments) | Configuration policy definitions for Security Hub (master account only) | <pre>map(object({<br>    target_id   = string,<br>    policy_name = string,<br>  }))</pre> | no |
