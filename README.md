...
| <a name="input_config_exclude_resource_types"></a> [config\_exclude\_resource\_types](#input\_config\_exclude\_resource\_types) | Resource types that will be excluded from config\_limit\_resource\_types in a non-main regions | `list(string)` | no |
