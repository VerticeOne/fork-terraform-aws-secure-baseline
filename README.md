...
| <a name="input_config_non_main_exclude_resource_types"></a> [config\_non\_main\_exclude\_resource\_types](#input\_config\_non\_main\_exclude\_resource\_types) | Resource types that will be excluded from config\_limit\_resource\_types in a non-main regions | `list(string)` | no |
