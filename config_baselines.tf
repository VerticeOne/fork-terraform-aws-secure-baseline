...
module "config_baseline_ap-northeast-1" {
  ...
  limit_resource_types          = var.region == "ap-northeast-1" ? var.config_limit_resource_types : setsubtract(var.config_limit_resource_types, var.config_exclude_resource_types)
...
module "config_baseline_ap-northeast-2" {
  ...
  limit_resource_types          = var.region == "ap-northeast-2" ? var.config_limit_resource_types : setsubtract(var.config_limit_resource_types, var.config_exclude_resource_types)
...
module "config_baseline_ap-northeast-3" {
  ...
  limit_resource_types          = var.region == "ap-northeast-3" ? var.config_limit_resource_types : setsubtract(var.config_limit_resource_types, var.config_exclude_resource_types)
...
module "config_baseline_ap-south-1" {
  ...
  limit_resource_types          = var.region == "ap-south-1" ? var.config_limit_resource_types : setsubtract(var.config_limit_resource_types, var.config_exclude_resource_types)
...
module "config_baseline_ap-southeast-1" {
  ...
  limit_resource_types          = var.region == "ap-southeast-1" ? var.config_limit_resource_types : setsubtract(var.config_limit_resource_types, var.config_exclude_resource_types)
...
module "config_baseline_ap-southeast-2" {
  ...
  limit_resource_types          = var.region == "ap-southeast-2" ? var.config_limit_resource_types : setsubtract(var.config_limit_resource_types, var.config_exclude_resource_types)
...
module "config_baseline_ca-central-1" {
  ...
  limit_resource_types          = var.region == "ca-central-1" ? var.config_limit_resource_types : setsubtract(var.config_limit_resource_types, var.config_exclude_resource_types)
...
module "config_baseline_eu-central-1" {
  ...
  limit_resource_types          = var.region == "eu-central-1" ? var.config_limit_resource_types : setsubtract(var.config_limit_resource_types, var.config_exclude_resource_types)
...
module "config_baseline_eu-north-1" {
  ...
  limit_resource_types          = var.region == "eu-north-1" ? var.config_limit_resource_types : setsubtract(var.config_limit_resource_types, var.config_exclude_resource_types)
...
module "config_baseline_eu-west-1" {
  ...
  limit_resource_types          = var.region == "eu-west-1" ? var.config_limit_resource_types : setsubtract(var.config_limit_resource_types, var.config_exclude_resource_types)
...
module "config_baseline_eu-west-2" {
  ...
  limit_resource_types          = var.region == "eu-west-2" ? var.config_limit_resource_types : setsubtract(var.config_limit_resource_types, var.config_exclude_resource_types)
...
module "config_baseline_eu-west-3" {
  ...
  limit_resource_types          = var.region == "eu-west-3" ? var.config_limit_resource_types : setsubtract(var.config_limit_resource_types, var.config_exclude_resource_types)
...
module "config_baseline_sa-east-1" {
  ...
  limit_resource_types          = var.region == "sa-east-1" ? var.config_limit_resource_types : setsubtract(var.config_limit_resource_types, var.config_exclude_resource_types)
...
module "config_baseline_us-east-1" {
  ...
  limit_resource_types          = var.region == "us-east-1" ? var.config_limit_resource_types : setsubtract(var.config_limit_resource_types, var.config_exclude_resource_types)
...
module "config_baseline_us-east-2" {
  ...
  limit_resource_types          = var.region == "us-east-2" ? var.config_limit_resource_types : setsubtract(var.config_limit_resource_types, var.config_exclude_resource_types)
...
module "config_baseline_us-west-1" {
  ...
  limit_resource_types          = var.region == "us-west-1" ? var.config_limit_resource_types : setsubtract(var.config_limit_resource_types, var.config_exclude_resource_types)
...
module "config_baseline_us-west-2" {
  ...
  limit_resource_types          = var.region == "us-west-2" ? var.config_limit_resource_types : setsubtract(var.config_limit_resource_types, var.config_exclude_resource_types)
